[[https://github.com/cobac/BayesianSR.jl/actions/workflows/Runtest.yml][https://github.com/cobac/BayesianSR.jl/actions/workflows/Runtest.yml/badge.svg]]
...
#+BEGIN_SRC julia :results silent :exports code
  ] add https://github.com/cobac/BayesianSR.jl
  using BayesianSR  
